...
contract MerkleTreeWithHistory {
    ...
    constructor(uint32 _levels, IPoseidon2 _hasher) {
    ...
    /**
    @dev Hash 3 tree leaves, returns Poseidon2(_left, _right, 0)
  */
    function hashLeftRight(
        ...
        require(uint256(_x) < FIELD_SIZE, "_x should be inside the field");
        require(uint256(_y) < FIELD_SIZE, "_y should be inside the field");
        uint256 res = _hasher.hash_2(uint256(_x), uint256(_y));
        return bytes32(res);
    }
